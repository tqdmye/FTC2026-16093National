...
//
//@Config
//@Autonomous(name = "Auto Red Far 27501")
//public class RedFarAuto27501 extends AutoCommandBase {
//
//    /* ================= Pose ================= */
//
...
//                .addPath(new BezierLine(scorePose, prepareCrossPose))
//                .setLinearHeadingInterpolation(scorePose.getHeading(), prepareCrossPose.getHeading())
//                .build();
...
//                .addPath(new BezierLine(intakeCrossPose, scorePose))
//                .setLinearHeadingInterpolation(intakeCrossPose.getHeading(), scorePose.getHeading())
//                .build();
//
//
//
...
//                new InstantCommand(() -> follower.setMaxPower(1)),
//                new driveAutoCommand(follower, intakeCross2, 2000),
//
//                new InstantCommand(() -> follower.setMaxPower(0.75)),
