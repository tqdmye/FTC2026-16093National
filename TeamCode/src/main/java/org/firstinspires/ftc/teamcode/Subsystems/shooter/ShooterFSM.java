...
public class ShooterFSM {
    ...
    public void accelerate_fast() {
        ...
        if(targetVelocity-shooterUp.getVelocity()>180){
            shooterAngleServo.setPosition(ShooterConstants.SHOOTER_TURRET_LONG.value+0.2);
        }
    ...
    public void accelerate_fast_preload_auto() {
        ...
        if(targetVelocity-shooterUp.getVelocity()>120){
            shooterAngleServo.setPosition(ShooterConstants.AUTO_SHOOTER_TURRET_LONG.value+0.28);
        }
        else if(targetVelocity-shooterUp.getVelocity()>80){
    ...
    public void accelerate_fast_auto() {
        ...
        shooterDown.setVelocity(ShooterConstants.AUTO_SHOOTER_FAST_VELOCITY.value);
        if(targetVelocity-shooterUp.getVelocity()>140){
    ...
    public void accelerate_mid_auto() {
        ...
        if(targetVelocity-shooterUp.getVelocity()>100){
            shooterAngleServo.setPosition(ShooterConstants.AUTO_SHOOTER_TURRET_MID.value+0.4);
        }
        else{
    ...
    public void accelerate_slow_auto() {
        targetVelocity = ShooterConstants.AUTO_SHOOTER_SLOW_VELOCITY.value;
        shooterUp.setVelocity(ShooterConstants.AUTO_SHOOTER_SLOW_VELOCITY.value);
        shooterDown.setVelocity(ShooterConstants.AUTO_SHOOTER_SLOW_VELOCITY.value);
        shooterAngleServo.setPosition(ShooterConstants.AUTO_SHOOTER_TURRET_SLOW.value);
    }
