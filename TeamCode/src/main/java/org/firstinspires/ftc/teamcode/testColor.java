...
public class testColor extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Rev2mDistanceSensor rev2mDistanceSensor = hardwareMap.get(Rev2mDistanceSensor.class,"distanceSensor");
        ...
        while (opModeIsActive()) {
            ...
            double distance = (rev2mDistanceSensor.getDistance(DistanceUnit.CM));
            if (distance <= 2 && !inZone) {
